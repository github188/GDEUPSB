...
public class GDEupsbLotTxnJnl {
   

	@Override
	public String toString() {
		return "GDEupsbLotTxnJnl [txnLog=" + txnLog + ", brNo=" + brNo
				+ ", logNo=" + logNo + ", tTxnCd=" + tTxnCd + ", txnCod="
				+ txnCod + ", schTyp=" + schTyp + ", schTit=" + schTit
				+ ", secLev=" + secLev + ", cityId=" + cityId + ", drawId="
				+ drawId + ", kenoId=" + kenoId + ", gameId=" + gameId
				+ ", gamNam=" + gamNam + ", playId=" + playId + ", betMet="
				+ betMet + ", betMod=" + betMod + ", betMul=" + betMul
				+ ", txnAmt=" + txnAmt + ", betLin=" + betLin + ", lotNam="
				+ lotNam + ", betDat=" + betDat + ", txnTim=" + txnTim
				+ ", schId=" + schId + ", tLogNo=" + tLogNo + ", cipher="
				+ cipher + ", verify=" + verify + ", cusNam=" + cusNam
				+ ", crdNo=" + crdNo + ", hTxnCd=" + hTxnCd + ", hTxnSb="
				+ hTxnSb + ", hLogNo=" + hLogNo + ", hRspCd=" + hRspCd
				+ ", hTxnSt=" + hTxnSt + ", tRspCd=" + tRspCd + ", tTxnSt="
				+ tTxnSt + ", thdChk=" + thdChk + ", tChkNo=" + tChkNo
				+ ", chkTim=" + chkTim + ", chkFlg=" + chkFlg + ", awdFlg="
				+ awdFlg + ", awdRtn=" + awdRtn + ", cAgtNo=" + cAgtNo
				+ ", tckNo=" + tckNo + ", txnCnl=" + txnCnl + ", betTyp="
				+ betTyp + ", lChkTm=" + lChkTm + ", txnSts=" + txnSts
				+ ", getTxnLog()=" + getTxnLog() + ", getBrNo()=" + getBrNo()
				+ ", getLogNo()=" + getLogNo() + ", gettTxnCd()=" + gettTxnCd()
				+ ", getTxnCod()=" + getTxnCod() + ", getSchTyp()="
				+ getSchTyp() + ", getSchTit()=" + getSchTit()
				+ ", getSecLev()=" + getSecLev() + ", getCityId()="
				+ getCityId() + ", getDrawId()=" + getDrawId()
				+ ", getKenoId()=" + getKenoId() + ", getGameId()="
				+ getGameId() + ", getGamNam()=" + getGamNam()
				+ ", getPlayId()=" + getPlayId() + ", getBetMet()="
				+ getBetMet() + ", getBetMod()=" + getBetMod()
				+ ", getBetMul()=" + getBetMul() + ", getTxnAmt()="
				+ getTxnAmt() + ", getBetLin()=" + getBetLin()
				+ ", getLotNam()=" + getLotNam() + ", getBetDat()="
				+ getBetDat() + ", getTxnTim()=" + getTxnTim()
				+ ", getSchId()=" + getSchId() + ", gettLogNo()=" + gettLogNo()
				+ ", getCipher()=" + getCipher() + ", getVerify()="
				+ getVerify() + ", getCusNam()=" + getCusNam()
				+ ", getCrdNo()=" + getCrdNo() + ", gethTxnCd()=" + gethTxnCd()
				+ ", gethTxnSb()=" + gethTxnSb() + ", gethLogNo()="
				+ gethLogNo() + ", gethRspCd()=" + gethRspCd()
				+ ", gethTxnSt()=" + gethTxnSt() + ", gettRspCd()="
				+ gettRspCd() + ", gettTxnSt()=" + gettTxnSt()
				+ ", getThdChk()=" + getThdChk() + ", gettChkNo()="
				+ gettChkNo() + ", getChkTim()=" + getChkTim()
				+ ", getChkFlg()=" + getChkFlg() + ", getAwdFlg()="
				+ getAwdFlg() + ", getAwdRtn()=" + getAwdRtn()
				+ ", getcAgtNo()=" + getcAgtNo() + ", getTckNo()=" + getTckNo()
				+ ", getTxnCnl()=" + getTxnCnl() + ", getBetTyp()="
				+ getBetTyp() + ", getlChkTm()=" + getlChkTm()
				+ ", getTxnSts()=" + getTxnSts() + ", getClass()=" + getClass()
	...
	public String getSchTit() {
		return schTit;
	}

	public void setSchTit(String schTit) {
		this.schTit = schTit;
	}
	...
	public String getAwdFlg() {
		return awdFlg;
	}

	public void setAwdFlg(String awdFlg) {
		this.awdFlg = awdFlg;
	}

	public String getAwdRtn() {
		return awdRtn;
	}

	public void setAwdRtn(String awdRtn) {
		this.awdRtn = awdRtn;
	}
	...
	public String getBetTyp() {
		return betTyp;
	}

	public void setBetTyp(String betTyp) {
		this.betTyp = betTyp;
	}

	public String getlChkTm() {
		return lChkTm;
	}

	public void setlChkTm(String lChkTm) {
		this.lChkTm = lChkTm;
	}
    ...
    private String awdFlg;

    private String awdRtn;
    ...
    private String betTyp;

    private String lChkTm;
