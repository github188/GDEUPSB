...
public class GdFbpdNeleBatchTmp {
    @Id
    @GeneratedValue
    private String sqn;
    ...
    private String cusDpm;

    private String feeMon;

    private String feeCnt;

    private String thdCusNme;

    private String eleAc;
    ...
    public String getSubDte() {
        return subDte;
    }

    public void setSubDte(String subDte) {
        this.subDte = subDte;
    }
    ...
    public String getCusDpm() {
        return cusDpm;
    }

    public void setCusDpm(String cusDpm) {
        this.cusDpm = cusDpm;
    }
    ...
    public String getFeeCnt() {
        return feeCnt;
    }

    public void setFeeCnt(String feeCnt) {
        this.feeCnt = feeCnt;
    }
