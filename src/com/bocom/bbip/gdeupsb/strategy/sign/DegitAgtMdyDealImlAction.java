 ...
 * 
 */
public class DegitAgtMdyDealImlAction implements AgtMdyDealImlService {
	...
	private final static Logger log = LoggerFactory.getLogger(DegitAgtMdyDealImlAction.class);
