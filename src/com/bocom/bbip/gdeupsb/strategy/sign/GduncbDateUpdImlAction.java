 ...
 * 
 */
public class GduncbDateUpdImlAction implements AgtDataUpdImlService {

	private final static Logger log = LoggerFactory.getLogger(GduncbDateUpdImlAction.class);
