...
public class CommDelCusAgentServiceActionWATR00 extends BaseAction implements DelCusAgentService{
	
	private static Logger logger = LoggerFactory.getLogger(CommDelCusAgentServiceActionWATR00.class);
	...
	public Map<String, Object> callThd(CustomerDomain customerdomain,List<CusAgentCollectDomain> list, Context context) throws CoreException {
		logger.error("CommDelCusAgentServiceActionWATR00 callThd start!");
...
//				StepSequenceFactory s = context.getService("logNoService");
		...
		if(context.getState().equals(BPState.BUSINESS_PROCESSNIG_STATE_NORMAL)){
			...
			if(Constants.RESPONSE_CODE_SUCC.equals(responseCode)){
				logger.info("CommDelCusAgentServiceActionWATR00 callThd success!");
			...
			logger.error("CommDelCusAgentServiceActionWATR00 callThd return has error!");
			throw new CoreException(ErrorCodes.EUPS_THD_SYS_ERROR);
		}
		logger.error("CommDelCusAgentServiceActionWATR00 callThd end!");
		return null;
	}

	@Override
	public Map<String, Object> preDel(CustomerDomain customerdomain,List<CusAgentCollectDomain> list, Context context) throws CoreException {
