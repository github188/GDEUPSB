...
public class CommUpdateCusAgentServiceActionWATR00 implements CommUpdateCusAgentService{
	...
	private static Logger logger = LoggerFactory.getLogger(CommUpdateCusAgentServiceActionWATR00.class);
	...
	public Map<String, Object> callThd(CustomerDomain customerdomain,List<CusAgentCollectDomain> list, Context context) throws CoreException {
		logger.error("CommUpdateCusAgentServiceActionWATR00 callThd start!");
...
//				StepSequenceFactory s = context.getService("logNoService");
		...
		if(context.getState().equals(BPState.BUSINESS_PROCESSNIG_STATE_NORMAL)){
			...
			if(Constants.RESPONSE_CODE_SUCC.equals(responseCode)){
				logger.info("CommUpdateCusAgentServiceActionWATR00 callThd success!");
			...
			logger.error("CommUpdateCusAgentServiceActionWATR00 callThd return has error!");
			throw new CoreException(ErrorCodes.EUPS_THD_SYS_ERROR);
		}
		logger.error("CommInsertCusAgentServiceActionWATR00 callThd end!");
		return null;
	}

	@Override
	public Map<String, Object> preUpdateCusAgent(CustomerDomain customerdomain,List<CusAgentCollectDomain> list, Context context)	throws CoreException {
