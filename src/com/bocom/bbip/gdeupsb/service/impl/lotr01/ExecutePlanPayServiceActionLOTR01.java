...
public class ExecutePlanPayServiceActionLOTR01 extends BaseAction {
	...
	public void getDrawInf(Context context) throws CoreException{
		logger.info("ExecutePlanPayStrategyActionLOTR01 getDrawInf start ... ...");
		String gameId = "5";
		String action = "235";
		...
		logger.info("ExecutePlanPayStrategyActionLOTR01 getDrawInf end ... ...");
	}
	...
	public void execute(Context context) throws CoreException,	CoreRuntimeException {
		...
		if(gdLotPlnCtls==null||gdLotPlnCtls.size()==0){
