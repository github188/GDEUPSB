...
public class GdmobbResult implements ThdTcpResult {
	private static final Log logger = LogFactory.getLog(GdmobbResult.class);
    ...
    public GdmobbResult(Map<String, Object> responseMap) {
        // 存储第三方返回信息
        ...
        if (null != responseMap) {
            ...
            //if (null != returnCode && returnCode.equals("00")) { // 返回码 00表示成功
    ...
    public GdmobbResult(Map<String, Object> responseMap, int status) {
