 ...
 * 
 */
public class AgtDataUpdImlServiceAction extends ServiceDelegatorAction {
	public AgtDataUpdImlServiceAction()
	{
	}

	public Map<String, Object> agtDateUpdService(Context context) throws CoreException, CoreRuntimeException {
		execute(context, "eups.batFilDelInitStrategyAction");
		if (StringUtils.isNotBlank(beanName))
		{
			Object agtFleSndImpl = ServiceRegistry.findService(beanName);
			if (agtFleSndImpl instanceof AgtDataUpdImlService)
			{
				Map<String, Object> returnMap = new HashMap<String, Object>();
				((AgtDataUpdImlService) agtFleSndImpl).agtDateUpdService(context);
				if (returnMap != null)
