...
public class BuaPaymentCancelUsingReversalExtTr extends BaseAction
{
  private static final Log logger = LogFactory.getLog(BuaPaymentCancelUsingReversalExtTr.class);
