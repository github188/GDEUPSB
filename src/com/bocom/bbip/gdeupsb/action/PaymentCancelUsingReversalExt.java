 ...
 * @since 1.0.0
 */
public class PaymentCancelUsingReversalExt extends BaseAction {

    /** Logger. */
    private static final Log logger = LogFactory.getLog(PaymentCancelUsingReversalExt.class);
