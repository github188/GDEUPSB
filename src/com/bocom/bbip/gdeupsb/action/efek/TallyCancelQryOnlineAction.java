...
//TODO						context.setData(ParamKeys.BANK_NO, );
						...
						context.setData(ParamKeys.CUS_NME, eupsTransJournal.getCusNme());
...
//TODO						context.setData(GDParamKeys.ELECTRICITY_YEARMONTH, );
				...
				//TODO
//				DefaultTransport defaultTransport=(DefaultTransport)get("");
//				try {
//					defaultTransport.submit(context.getDataMap(), context);
