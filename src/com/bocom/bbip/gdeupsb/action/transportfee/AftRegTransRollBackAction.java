...
public class AftRegTransRollBackAction extends BaseAction{
	private final static Log log = LogFactory.getLog(AftRegTransRollBackAction.class);
	...
	public void execute(Context ctx) throws CoreException,CoreRuntimeException{
		log.info("AftRegTransRollBackAction start......");
