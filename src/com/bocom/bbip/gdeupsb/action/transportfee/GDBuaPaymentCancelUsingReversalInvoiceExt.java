...
public class GDBuaPaymentCancelUsingReversalInvoiceExt extends BaseAction{
	private final static Log logger = LogFactory.getLog(GDBuaPaymentCancelUsingReversalInvoiceExt.class);
