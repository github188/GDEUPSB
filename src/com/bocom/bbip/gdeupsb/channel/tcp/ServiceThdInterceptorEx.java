...
public class ServiceThdInterceptorEx extends BaseAction implements ChannelInterceptor {
    ...
    private final static Logger log = LoggerFactory.getLogger(ServiceThdInterceptorEx.class);

    private Map<String, String> loadMap;

    public ServiceThdInterceptorEx(String port) {
        this.port = port;
...
//            }
        ...
        contextex.setData("teller", "ele01");
        contextex.setData("tlr", "ele01");
        contextex.setData(ParamKeys.TERMINAL, "ele01");
