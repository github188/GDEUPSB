...
public class PrePayElecStrategyAction implements Executable {
	...
	public void execute(Context context) throws CoreException, CoreRuntimeException {
		...
		//TODO:AcpsCorporInfo 单位协议检查
//		AcpsCorporInfo acpsInfo=acpsCorporInfoRepository.findOne(realSplNo);
//		if(null==acpsInfo){
//			throw new CoreException(ErrorCodes.EUPS_COM_NO_NOTEXIST);
//		}
//	        
	    ...
	    //对私
	    if(GDConstants.GZ_ELE_PAY_KND_CASH.equals(vchTyp)||GDConstants.GZ_ELE_PAY_KND_CARD.equals(vchTyp)||GDConstants.GZ_ELE_PAY_KND_ALVC.equals(vchTyp)||GDConstants.GZ_ELE_PAY_KND_AOVC.equals(vchTyp)||GDConstants.GZ_ELE_PAY_KND_PRCK.equals(vchTyp))
	    {
	    	context.setData("rmkCde", "9102");  //备注
	    	
	    } 
	    else{   //对公 
	    	context.setData(ParamKeys.BUSS_KIND, GDConstants.GZ_ELE_BUS_KND_ELEC);  //业务种类：电费
